...
callfullmoon.itemRightClick = function(stack, world, player, hand) {
    ...
    player.sendChat("In the frozen land, new answers may be found!");
...
callbloodhunt.itemRightClick = function(stack, world, player, hand) {
    ...
    player.sendChat("In deepest dark, new answers may be found!");
...
embiggener.itemRightClick = function(stack, world, player, hand) {
    ...
    player.sendChat("Where islands fly, new answers may be found!");
...
recursivepaperdunerider.itemRightClick = function(stack, world, player, hand) {
    ...
    player.sendChat("Where fire blazes, new answers may be found!");
...
sprensummonerglory.itemRightClick = function(stack, world, player, hand) {
    ...
    Commands.call("summon minecraft:horse ~ ~5 ~ {PersistenceRequired:1,Tags:[\"sprenglory\"],CustomName:\"Spren of Glory\"}", player, world, false, true);
    stack.shrink(1);
    return "PASS";
...
summonstothearmyofdarkness.itemRightClick = function(stack, world, player, hand) {
    ...
    if(player.getDimension() != 810) {
        player.sendChat("You gotta be in Greckon");
        return "FAIL";
    }
    ...
    Commands.call("summon aoa3:grillface ~ ~6 ~ {HandItems:[{Count:1,id:\"contenttweaker:horn_of_the_dark_goat\"},{}],HandDropChances:[1.0f,0.0f],Attributes:[{Name:generic.maxHealth, Base:300000.0},{Name:generic.attackDamage, Base:1000.0}],Health:300000f,CustomName:\"Shluhnaggah, the Dark Goat\"}", player, world, false, true);
...
beekeperarchive.itemRightClick = function(stack, world, player, hand) {
    ...
    Commands.call("/tellraw @a {\"text\":\"Click here to access the online version of the bee breeding tree!\",\"underlined\":true,\"color\":\"blue\",\"clickEvent\":{\"action\":\"open_url\",\"value\":\"https://at-l4s.github.io/BeeBreeding/\"}}", player, world, false, true);
    stack.shrink(1);
    return "PASS";
...
sunderingofthetwilitcurse.itemRightClick = function(stack, world, player, hand) {
    ...
    if(player.getDimension() != 7) {
        player.sendChat("Use inside the Crimson Cult structures in the Twilight Forest");
        return "FAIL";
    }
    player.sendChat("Use inside the Crimson Cult structures in the Twilight Forest");
...
silencingnothingness.itemRightClick = function(stack, world, player, hand) {
    ...
    if(posChange.y > -100) {
        player.sendChat("Go deeper, much deeper");
        return "FAIL";
    }
